...
uniform	vec4	light_position_view_space_array[8];
uniform	vec4	light_direction_view_space_array[8];
uniform	vec4	light_attenuation_array[8];
uniform	vec4	spotlight_params_array[8];
uniform	vec4	derived_light_diffuse_colour_array[8];
