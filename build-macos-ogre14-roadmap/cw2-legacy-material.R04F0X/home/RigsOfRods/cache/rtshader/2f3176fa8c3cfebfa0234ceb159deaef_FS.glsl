...
void main(void) {
	...
	texel_1	=	texture2D(gTextureSampler1, vsTexcoord_2);
	ENABLE_LINEAR_COLOUR(texel_1);
	texel_2	=	texture2D(gTextureSampler2, vsTexcoord_3);
	ENABLE_LINEAR_COLOUR(texel_2);
	texel_2	=	texture2D(gTextureSampler2, vsTexcoord_3);
	ENABLE_LINEAR_COLOUR(texel_2);
	gl_FragColor	=	texel_0*gl_FragColor;
	gl_FragColor.xyz	=	mix(gl_FragColor.xyz, texel_1.xyz, texel_1.w);
	gl_FragColor.w	=	texel_1.w*gl_FragColor.w;
	gl_FragColor.xyz	=	mix(gl_FragColor.xyz, texel_2.xyz, gl_FragColor.w);
	gl_FragColor.w	=	texel_2.w*gl_FragColor.w;
