...
void main(void) {
	...
	evaluateLight(vsTexcoord_0, vsTexcoord_1, light_position_view_space_array[int(9.00000)], light_attenuation_array[int(9.00000)], light_direction_view_space_array[int(9.00000)], spotlight_params_array[int(9.00000)], derived_light_diffuse_colour_array[int(9.00000)], gl_FragColor.xyz);
	evaluateLight(vsTexcoord_0, vsTexcoord_1, light_position_view_space_array[int(10.0000)], light_attenuation_array[int(10.0000)], light_direction_view_space_array[int(10.0000)], spotlight_params_array[int(10.0000)], derived_light_diffuse_colour_array[int(10.0000)], gl_FragColor.xyz);
	evaluateLight(vsTexcoord_0, vsTexcoord_1, light_position_view_space_array[int(11.0000)], light_attenuation_array[int(11.0000)], light_direction_view_space_array[int(11.0000)], spotlight_params_array[int(11.0000)], derived_light_diffuse_colour_array[int(11.0000)], gl_FragColor.xyz);
	evaluateLight(vsTexcoord_0, vsTexcoord_1, light_position_view_space_array[int(12.0000)], light_attenuation_array[int(12.0000)], light_direction_view_space_array[int(12.0000)], spotlight_params_array[int(12.0000)], derived_light_diffuse_colour_array[int(12.0000)], gl_FragColor.xyz);
	lColor_0	=	gl_FragColor;
	texel_0	=	texture2D(gTextureSampler0, vsTexcoord_2);
	ENABLE_LINEAR_COLOUR(texel_0);
	texel_1	=	texture2D(gTextureSampler1, vsTexcoord_2);
	ENABLE_LINEAR_COLOUR(texel_1);
	gl_FragColor	=	texel_0*gl_FragColor;
	gl_FragColor.xyz	=	mix(gl_FragColor.xyz, vec4(0.00000,0.00000,0.00000,1.00000).xyz, gl_FragColor.w);
