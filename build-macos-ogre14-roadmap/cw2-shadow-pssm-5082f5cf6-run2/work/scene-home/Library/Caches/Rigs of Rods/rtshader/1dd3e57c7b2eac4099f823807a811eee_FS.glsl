...
void main(void) {
	...
	SGX_ComputeShadowFactor_PSSM3(fdepth, pssm_split_points0, vsTexcoord_0, shadow_map2, inverse_texture_size2.xy, vsTexcoord_1, shadow_map3, inverse_texture_size3.xy, vsTexcoord_2, shadow_map4, inverse_texture_size4.xy, lShadowFactor[int(0.00000)]);
	...
	texel_0	=	texture2D(gTextureSampler0, vsTexcoord_5);
	ENABLE_LINEAR_COLOUR(texel_0);
	texel_1	=	texture2D(gTextureSampler1, vsTexcoord_5);
