...
def load_lock(path: Path = LOCK_PATH) -> dict[str, Any]:
    ...
    expected_lod_tail_patch_sha256 = (
        "9ad553e923aa20c12aa46381d568f7423ee2b792f104fdf06f062e74523d1848"
    )
    expected_light_list_tail_patch_sha256 = (
        "cc5c411a6af01eb83017147b4146d33561f936e135abf283bcd02b17a07b27ff"
    )
    expected_global_light_capacity_patch_sha256 = (
        "5f267f1b16351646c622cf6217c7aa7315f0dbbba317bad9b527b954962ce1f7"
    )
    ...
    expected_patches = [
        ...
        },
        {
            ...
            "reason": (
                "Restrict parallel LOD writes to valid SIMD lanes and real "
                "objects so render-queue tail padding and fragmented slots "
                "never mutate a shared ObjectMemoryManager dummy object"
            ),
            "sources": [
                {
        ...
        },
        {
            ...
            "reason": (
                "Bound phase-one light-cull writes to each worker's reserved "
                "live lanes and exclude padded and fragmented NullEntity lanes "
                "from parallel legacy light-list mutation"
            ),
        ...
        {
            "path": "patches/0015-global-light-list-packed-capacity.patch",
            "sha256": expected_global_light_capacity_patch_sha256,
            "reason": (
                "Recompute fragmented packed-light capacity after light type "
                "and render-queue staging so parallel light culling cannot "
                "address beyond global list storage"
            ),
            "source_path": "OgreMain/src/OgreSceneManager.cpp",
            "source_sha256": (
...
def load_linux_shader_toolchain_lock(
    ...
    if (
        ...
        != "591891d12aa3d529ca31d0db283bf279a90e2a719d7443933e8ef72267bf7dbb"
    ):
