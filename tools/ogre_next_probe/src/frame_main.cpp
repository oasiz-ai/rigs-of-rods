...
namespace
{
    ...
    std::string makeReport( const FrameResult &result )
    {
        ...
        report << "{\n"
               ...
               << "    \"shader_media_root\": \""
               << ROR_OGRE_NEXT_FRAME_SHADER_MEDIA_ROOT << "\",\n"
               << "    \"shader_media_license_expression\": \""
               << ROR_OGRE_NEXT_FRAME_SHADER_MEDIA_LICENSE_EXPRESSION << "\",\n"
               << "    \"shader_media_third_party_source_path\": \""
               << ROR_OGRE_NEXT_FRAME_SHADER_MEDIA_SOURCE_PATH << "\",\n"
               << "    \"shader_media_third_party_source_sha256\": \""
               << ROR_OGRE_NEXT_FRAME_SHADER_MEDIA_SOURCE_SHA256 << "\",\n"
               << "    \"shader_media_notice_path\": \""
               << ROR_OGRE_NEXT_FRAME_SHADER_MEDIA_NOTICE_PATH << "\",\n"
               << "    \"shader_media_notice_sha256\": \""
               << ROR_OGRE_NEXT_FRAME_SHADER_MEDIA_NOTICE_SHA256 << "\",\n"
               << "    \"shader_media_upstream_source\": \""
               << ROR_OGRE_NEXT_FRAME_SHADER_MEDIA_UPSTREAM_SOURCE << "\",\n"
               << "    \"shader_media_paper_reference\": \""
               << ROR_OGRE_NEXT_FRAME_SHADER_MEDIA_PAPER_REFERENCE << "\",\n"
