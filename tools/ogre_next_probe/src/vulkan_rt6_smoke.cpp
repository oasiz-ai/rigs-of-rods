...
std::string MakeReport(const char* status, const std::string& reason,
  ...
  report
      ...
      << "    \"blas_count\": " << evidence.semantic_blas_count << ",\n"
      << "    \"receiver_blas_device_address\": "
      << evidence.blas_device_address << ",\n"
      << "    \"occluder_blas_device_address\": "
      << evidence.semantic_occluder_blas_device_address << ",\n"
      << "    \"tlas_instance_count\": "
      << evidence.semantic_tlas_instance_count << ",\n"
      << "    \"sample_count\": " << evidence.semantic_sample_count
      << ",\n"
      << "    \"primary_receiver_ray_count_total\": "
      << evidence.semantic_primary_receiver_ray_count << ",\n"
      << "    \"directional_visibility_ray_count_total\": "
      << evidence.semantic_directional_visibility_ray_count << ",\n"
      << "    \"primary_receiver_rays_per_sample\": "
      << (evidence.semantic_sample_count == 2U ? 1U : 0U) << ",\n"
      << "    \"directional_visibility_rays_per_sample\": "
      << (evidence.semantic_sample_count == 2U ? 1U : 0U) << ",\n"
      << "    \"receiver_blas_built\": "
      << JsonBool(evidence.semantic_receiver_blas_built) << ",\n"
      << "    \"occluder_blas_built\": "
      << JsonBool(evidence.semantic_occluder_blas_built) << ",\n"
      << "    \"tlas_built\": "
      << JsonBool(evidence.semantic_tlas_built) << ",\n"
      << "    \"controlled_geometry_exact\": "
      << JsonBool(evidence.semantic_controlled_geometry_exact) << ",\n"
      << "    \"visibility_encoding\": \"R16_FLOAT_binary16\",\n"
      << "    \"visibility_r16_bits\": ["
      << evidence.semantic_visibility_r16_bits[0U] << ", "
      << evidence.semantic_visibility_r16_bits[1U] << "],\n"
      << "    \"lineage_encoding\": \"R32_UINT_instance_bitset\",\n"
      << "    \"lineage_r32\": ["
      << evidence.semantic_lineage_r32[0U] << ", "
      << evidence.semantic_lineage_r32[1U] << "],\n"
      << "    \"raster_encoding\": \"canonical_RGBA16_FLOAT_binary16\",\n"
      << "    \"raster_rgba16_bits\": [["
      << evidence.semantic_raster_rgba16_bits[0U][0U] << ", "
      << evidence.semantic_raster_rgba16_bits[0U][1U] << ", "
      << evidence.semantic_raster_rgba16_bits[0U][2U] << ", "
      << evidence.semantic_raster_rgba16_bits[0U][3U] << "], ["
      << evidence.semantic_raster_rgba16_bits[1U][0U] << ", "
      << evidence.semantic_raster_rgba16_bits[1U][1U] << ", "
      << evidence.semantic_raster_rgba16_bits[1U][2U] << ", "
      << evidence.semantic_raster_rgba16_bits[1U][3U] << "]],\n"
      << "    \"hybrid_rgba16_bits\": [["
      << evidence.semantic_hybrid_rgba16_bits[0U][0U] << ", "
      << evidence.semantic_hybrid_rgba16_bits[0U][1U] << ", "
      << evidence.semantic_hybrid_rgba16_bits[0U][2U] << ", "
      << evidence.semantic_hybrid_rgba16_bits[0U][3U] << "], ["
      << evidence.semantic_hybrid_rgba16_bits[1U][0U] << ", "
      << evidence.semantic_hybrid_rgba16_bits[1U][1U] << ", "
      << evidence.semantic_hybrid_rgba16_bits[1U][2U] << ", "
      << evidence.semantic_hybrid_rgba16_bits[1U][3U] << "]],\n"
      << "    \"readback_completed\": "
      << JsonBool(evidence.semantic_readback_completed) << ",\n"
      << "    \"portable_sample_oracle_passed\": "
      << JsonBool(evidence.semantic_sample_oracle_passed) << "\n"
      << "  },\n"
...
int main(int argc, char** argv) {
  ...
  try {
    ...
    std::cout << "RT6 Vulkan KHR primary-hit and N4A semantic directional "
                 "shadow proofs passed\n";
    return 0;
  } catch (const std::exception& error) {
