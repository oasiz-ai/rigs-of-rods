...
void RoR::RegisterActor(asIScriptEngine *engine)
{
    ...
    result = engine->RegisterObjectMethod("BeamClass", "bool trySetDeterministicImpactPlacementAndVelocity(vector3, vector3)", asMETHOD(Actor, trySetDeterministicImpactPlacementAndVelocity), asCALL_THISCALL); ROR_ASSERT(result >= 0);
    ...
    result = engine->RegisterObjectMethod("BeamClass", "int getJBeamHydroRuntimeCount() const", AngelScript::asMETHOD(Actor, getJBeamHydroRuntimeCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "int getJBeamHydroRuntimeFaultCount() const", AngelScript::asMETHOD(Actor, getJBeamHydroRuntimeFaultCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "bool hasFiniteJBeamHydroRuntimeState() const", AngelScript::asMETHOD(Actor, hasFiniteJBeamHydroRuntimeState), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "uint64 getJBeamHydroMinimumAcceptedStepCount() const", AngelScript::asMETHOD(Actor, getJBeamHydroMinimumAcceptedStepCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "uint64 getJBeamHydroMaximumAcceptedStepCount() const", AngelScript::asMETHOD(Actor, getJBeamHydroMaximumAcceptedStepCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "double getJBeamHydroMinimumLengthRatio() const", AngelScript::asMETHOD(Actor, getJBeamHydroMinimumLengthRatio), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "double getJBeamHydroMaximumLengthRatio() const", AngelScript::asMETHOD(Actor, getJBeamHydroMaximumLengthRatio), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "bool trySetJBeamHydroSteeringCommand(float)", AngelScript::asMETHOD(Actor, trySetJBeamHydroSteeringCommand), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "int getJBeamSupportRuntimeCount() const", AngelScript::asMETHOD(Actor, getJBeamSupportRuntimeCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "int getJBeamSupportRuntimeFaultCount() const", AngelScript::asMETHOD(Actor, getJBeamSupportRuntimeFaultCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "bool hasFiniteJBeamSupportRuntimeState() const", AngelScript::asMETHOD(Actor, hasFiniteJBeamSupportRuntimeState), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "uint64 getJBeamSupportMinimumAcceptedStepCount() const", AngelScript::asMETHOD(Actor, getJBeamSupportMinimumAcceptedStepCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "uint64 getJBeamSupportMaximumAcceptedStepCount() const", AngelScript::asMETHOD(Actor, getJBeamSupportMaximumAcceptedStepCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "uint64 getJBeamSupportMinimumCompressionStepCount() const", AngelScript::asMETHOD(Actor, getJBeamSupportMinimumCompressionStepCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "int getBeamCount() const", AngelScript::asMETHOD(Actor, getBeamCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "int getCabTriangleCount() const", AngelScript::asMETHOD(Actor, getCabTriangleCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "int getCollisionCabTriangleCount() const", AngelScript::asMETHOD(Actor, getCollisionCabTriangleCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "int getContacterCount() const", AngelScript::asMETHOD(Actor, getContacterCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
    result = engine->RegisterObjectMethod("BeamClass", "int getGroundContactEnabledNodeCount() const", AngelScript::asMETHOD(Actor, getGroundContactEnabledNodeCount), AngelScript::asCALL_THISCALL); ROR_ASSERT(result >= 0);
