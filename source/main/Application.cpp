...
CVar* sim_deterministic_input_mode;
CVar* sim_deterministic_input_path;
CVar* sim_deterministic_input_scenario_id;
CVar* sim_deterministic_input_target_id;
CVar* sim_deterministic_input_step_limit;
CVar* gfx_frame_budget_mode;
CVar* gfx_frame_budget_receipt_path;
CVar* gfx_frame_budget_scenario_id;
CVar* gfx_frame_budget_sustained_ms;
CVar* gfx_frame_budget_percentile;
CVar* gfx_frame_budget_percentile_ms;
CVar* gfx_frame_budget_warmup_frames;
CVar* gfx_frame_budget_minimum_frames;
CVar* gfx_frame_budget_requested_frames;
