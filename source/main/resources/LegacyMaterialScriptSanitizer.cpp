...
const LegacyMaterialScriptEdit CITYWORLD_DNEBUILDINGS_EDITS[] = {
    {LegacyMaterialScriptEditKind::REPLACE_TOKEN_ON_LINE,
     ...
     "texture cityworld_next_replacements/brickwall_darkred_1024.dds"},
    {LegacyMaterialScriptEditKind::REMOVE_TRIMMED_LINE,
     2385U, "texture_unit", ""},
    {LegacyMaterialScriptEditKind::REPLACE_TOKEN_ON_LINE,
     2566U,
     "texture lightgreybrick.dds",
     "texture cityworld_next_replacements/lightgreybrick_1024.dds"},
    {LegacyMaterialScriptEditKind::REPLACE_TOKEN_ON_LINE,
     2607U,
     "texture betterbrickdiffuse.dds",
     "texture cityworld_next_replacements/betterbrickdiffuse_1024.dds"},
    {LegacyMaterialScriptEditKind::REPLACE_TOKEN_ON_LINE,
     2637U,
     "texture concretetan.dds",
     "texture cityworld_next_replacements/concretetan_1024.dds"},
    {LegacyMaterialScriptEditKind::REPLACE_TOKEN_ON_LINE,
     2667U,
     "texture concretelightgrey.dds",
     "texture cityworld_next_replacements/concretelightgrey_1024.dds"},
    {LegacyMaterialScriptEditKind::REPLACE_TOKEN_ON_LINE,
     3205U,
     "texture brickwall_darkred.dds",
     "texture cityworld_next_replacements/brickwall_darkred_1024.dds"},
...
const LegacyMaterialScriptEdit CITYWORLD_ASIA_EDITS[] = {
    {LegacyMaterialScriptEditKind::REPLACE_TOKEN_ON_LINE,
     ...
     "texture cityworld_next_replacements/asiaconcrete_1024.dds"},
    {LegacyMaterialScriptEditKind::REPLACE_TOKEN_ON_LINE,
     51U,
     "texture darkcrete.dds",
     "texture cityworld_next_replacements/darkcrete_1024.dds"},
    {LegacyMaterialScriptEditKind::REPLACE_TOKEN_ON_LINE,
     65U,
     "texture redcrete.dds",
     "texture cityworld_next_replacements/redcrete_1024.dds"}};
