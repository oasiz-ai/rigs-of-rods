...
foreach(_resource_name IN ITEMS resources languages content plugins.cfg)
...
endforeach()
file(WRITE "${_ror_bundle_resources}/plugins.cfg" "${_generated_plugins_cfg}")
_ror_run_checked(
    "Linking the bundle-relative plugin configuration beside the executable"
    "${CMAKE_COMMAND}" -E create_symlink
    "../Resources/plugins.cfg" "${_ror_macos}/plugins.cfg")
