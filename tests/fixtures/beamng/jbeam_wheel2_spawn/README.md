...
sample, not a per-step bound. The run is seeded with a bounded 1 m/s downward
impact. The receipt does not qualify gravity response, contact behavior,
static load, or whether the structure settles. It also does not claim
