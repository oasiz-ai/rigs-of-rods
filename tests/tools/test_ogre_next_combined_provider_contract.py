...
class CombinedProviderContractTests(unittest.TestCase):
    ...
    def test_namespace_audit_contract_tracks_the_complete_base_patch_set(self) -> None:
        for token in (
            ...
            '"header_source_sha256": "@ROR_OGRE_NEXT_BARRIER_HEADER_SOURCE_SHA256@"',
            '"header_patched_sha256": "@ROR_OGRE_NEXT_BARRIER_HEADER_PATCHED_SHA256@"',
            '"implementation_source_sha256": "@ROR_OGRE_NEXT_BARRIER_IMPLEMENTATION_SOURCE_SHA256@"',
            '"implementation_patched_sha256": "@ROR_OGRE_NEXT_BARRIER_IMPLEMENTATION_PATCHED_SHA256@"',
            '"path": "@ROR_OGRE_NEXT_FORWARD_CLUSTERED_PATCH_PATH@"',
            '"sha256": "@ROR_OGRE_NEXT_FORWARD_CLUSTERED_PATCH_SHA256@"',
            '"header_source_sha256": "@ROR_OGRE_NEXT_FORWARD_CLUSTERED_HEADER_SOURCE_SHA256@"',
            '"header_patched_sha256": "@ROR_OGRE_NEXT_FORWARD_CLUSTERED_HEADER_PATCHED_SHA256@"',
            '"implementation_source_sha256": "@ROR_OGRE_NEXT_FORWARD_CLUSTERED_IMPLEMENTATION_SOURCE_SHA256@"',
            '"implementation_patched_sha256": "@ROR_OGRE_NEXT_FORWARD_CLUSTERED_IMPLEMENTATION_PATCHED_SHA256@"',
    ...
    def test_provider_reuses_exact_root_sdl_and_never_fetches_it(self) -> None:
        for token in (
            ...
            "_ror_root_sdl_imported_location_configs",
            ...
            "imported archive is outside the exact locked package path",
            "does not link its exact imported archive target",
    ...
    def test_linux_install_and_launcher_select_the_combined_executable(self) -> None:
        ...
        for source in (
            ...
            "tests/fixtures/beamng/jbeam_wheel2_spawn/LICENSE.md",
            "tests/fixtures/beamng/jbeam_wheel2_spawn/README.md",
    ...
    def test_linux_combined_workflow_builds_installs_and_smokes_one_target(self) -> None:
        ...
        for token in (
            ...
            "ror.ogre_next_combined_linux_package.v8",
            ...
            "simple2_a.terrn2",
            "b6b0UID-semi.truck",
            '"startup_capture_rejections"',
            '"presentation_ownership"',
            '"native_distance_lod"',
            '"actor_control"',
            '"actor_control_driver"',
            "--qualify-actor-control",
            "--actor-control-hold-seconds 30",
            "x11-xtest-xdotool",
            ...
            "Prove pressureWheel spawn topology counts and node classes",
            "tools/run_jbeam_wheel2_spawn.py",
            ...
            "spawn-topology-counts-node-classes-finite-batch-boundary-state-not-vehicle-parity",
        ...
        for retired in (
            ...
            '"exactGeneratedTopology": True',
            "boundedGravityIntervalSafety",
            "finitePositiveNodeState",
            "gravity_interval_safety_envelope",
            "spawn-topology-finite-gravity-interval",
    ...
    def test_windows_combined_workflow_builds_installs_and_smokes_one_target(
        ...
        for token in (
            ...
            "$cmakeArguments = @(",
            '"-DCMAKE_PROJECT_TOP_LEVEL_INCLUDES=$conanProvider"',
            '"-DCONAN_HOST_PROFILE=$conanProfile"',
            ...
            "ror-combined-build/bin/RoR-Combined.pdb",
            "ror-combined-smoke/",
            "WaitForExit(120000)",
