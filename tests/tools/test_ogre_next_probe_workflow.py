...
class OgreNextProbeWorkflowTests(unittest.TestCase):
    ...
    def test_ogre14_scene_adapter_is_exactly_tapped_and_fail_closed(self) -> None:
        ...
        self.assertIn("light == terrain_main_light", demo_light)
        self.assertIn("if (candidate == nullptr)", demo_light)
        self.assertIn("capturing only the terrain main light", demo_light)
